...
<Project DefaultTargets="Build" ToolsVersion="14.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Label="Globals">
    <ProjectGuid>{3C1FCAAC-C88A-C2F3-1C55-9543721AF9C9}</ProjectGuid>
  ...
  <ItemDefinitionGroup Condition="'$(Configuration)|$(Platform)'=='Debug|x64'">
    <ClCompile>
      <AdditionalIncludeDirectories>C:\Users\kamalakannan.ayyau\.node-gyp\8.9.1\include\node;C:\Users\kamalakannan.ayyau\.node-gyp\8.9.1\src;C:\Users\kamalakannan.ayyau\.node-gyp\8.9.1\deps\uv\include;C:\Users\kamalakannan.ayyau\.node-gyp\8.9.1\deps\v8\include;%(AdditionalIncludeDirectories)</AdditionalIncludeDirectories>
  ...
  <ItemGroup>
    <CustomBuild Include="$(OutDir)\profiler.node">
      <FileType>Document</FileType>
      <Command>call mkdir &quot;D:\Move POC\MoveClusterAPI\node_modules\v8-profiler\build\profiler\v5.7.0\node-v57-win32-x64&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;$(OutDir)profiler.node&quot; &quot;D:\Move POC\MoveClusterAPI\node_modules\v8-profiler\build\profiler\v5.7.0\node-v57-win32-x64\profiler.node&quot;&#xD;&#xA;if %errorlevel% neq 0 exit /b %errorlevel%</Command>
      <Message>Copying $(OutDir)/profiler.node to D:/Move POC/MoveClusterAPI/node_modules/v8-profiler/build/profiler/v5.7.0/node-v57-win32-x64\profiler.node</Message>
      <Outputs>D:\Move POC\MoveClusterAPI\node_modules\v8-profiler\build\profiler\v5.7.0\node-v57-win32-x64\profiler.node</Outputs>
    </CustomBuild>
  </ItemGroup>
  <ItemGroup>
    <ProjectReference Include="profiler.vcxproj">
      <Project>{6CBA9FD9-C9F4-E9FB-6D7A-BB0DF63DC055}</Project>
